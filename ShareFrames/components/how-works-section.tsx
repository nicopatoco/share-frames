          ...
          <div className="flex justify-between">
            <div className="w-1/3 px-4">
              <div className="flex flex-col items-center text-center">
                ...
                <p>
                Aenean commodo venenatis eros sit amet maximus. Vivamus posuere turpis ut interdum malesuada. Pellentesque quis sollicitudin nisl. Vivamus pharetra ac ex placerat fermentum. Vivamus volutpat dui porttitor, molestie metus placerat.
                </p>
              </div>
            </div>
            <div className="w-1/3 px-4">
